...
var addToCartBottons = document.getElementsByClassName('shop-item-btn')
...
function addItemToCart(title, price, imageSrc){
    ...
    `<div class="cart-item cart-column">
        <img class="cart-item-image" src="${imageSrc}" alt="t shirt" width="50px" height="50px">
...
function updateCartTotal() {
    ...
    for(var i=0; i<cartRows.length; i++){
        ...
        var quantityval = quantityElement.value
        total = total + price*quantityval
    }
